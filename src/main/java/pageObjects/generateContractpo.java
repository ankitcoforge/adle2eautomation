...
public class generateContractpo extends baseClass{
	
	public String gcModelBox =  ".adl-modal__container";
	...
	public String genrateContractButton = "(//span[contains(text(),'Generate Contract')])[2]";
