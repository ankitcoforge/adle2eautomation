...
public class toolBoxpo extends baseClass {
	...
	public String TBLenderTab ="//*[contains(text(),\"Lender Company Toolbox\")]";
	...
	public String TBMyAccountStatementAndActurialStatementsJobAidReport = "//a[contains(text(),\"My Account Statements & Actuarial Statements Job Aid\")]";
	...
	public String TBLimitedWarrantyForm1 = "//a[text()='Limited Warranty']";
...
//	Agent Forms Library
	...
	public String TBClassicTrakAncillaryDealerAgreement = "//a[contains(text(),\"ClassicTrack Ancillary Dealer Agreement\")]";
