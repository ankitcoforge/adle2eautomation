...
//				if (i == 10) 	
	 ...
	 public HashMap<Integer, HashMap<String, WebElement>> checkGridForEditLockResendInvitationImpersonateForAgentDealerLenderRole() throws InterruptedException {
			List<String> allHeaderNames = event.getTextValuesForObject("cssSelector", headerLoc);
			System.out.println("allHeaderNames: " + allHeaderNames);
...
//			}
	 ...
	 public HashMap<Integer, HashMap<String, WebElement>> checkGridForEditLockResendInvitationImpersonateForAllRolesExceptagentDealerLender() throws InterruptedException {
			List<String> allHeaderNames = event.getTextValuesForObject("cssSelector", headerLoc);
			System.out.println("allHeaderNames: " + allHeaderNames);
			HashMap<Integer, HashMap<String, WebElement>> allTableData = new HashMap<Integer, HashMap<String, WebElement>>();
			// Get total rows count
